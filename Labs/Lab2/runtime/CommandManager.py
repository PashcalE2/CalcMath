...
from Labs.Lab2.runtime.ExitCommand import ExitCommand
from Labs.Lab2.runtime.HelpCommand import HelpCommand
from Labs.Lab2.runtime.Lab2ManyCommand import Lab2ManyCommand
from Labs.Lab2.runtime.Lab2OneCommand import Lab2OneCommand
...
class CommandManager(AnyManager):
    def __init__(self, iostream: MyInputOutputStream):
        ...
        self.add_command(Lab2OneCommand(self))
        self.add_command(Lab2ManyCommand(self))
